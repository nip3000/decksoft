        ...
        <nav className="hidden md:flex items-center gap-6">
          {navLinks.map((link) => (
            <button
              ...
              className={cn(
                "relative px-3 py-1.5 rounded-md transition-all duration-500 ease-in-out after:content-[''] after:absolute after:w-[calc(100%-24px)] after:h-0.5 after:bottom-1 after:left-3 after:bg-primary after:transition-all after:duration-500 after:ease-in-out",
                activeSection === link.id
                  ? "text-primary font-medium bg-primary/10 after:scale-x-100 after:opacity-100"
                  : "text-muted-foreground hover:text-foreground hover:bg-muted/50 after:scale-x-0 after:opacity-0 after:origin-bottom-right hover:after:scale-x-100 hover:after:opacity-100 hover:after:origin-bottom-left"
              )}
            >
              {link.label}
            </button>
